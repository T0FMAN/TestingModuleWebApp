...
namespace ImportantStuff
{
	internal class Program
	{
		...
		private const string ApplicationName = "TestingModuleWebApp";
		private const string SpreadsheetId = "1v4V7Mn_gYukethZqoo9Y_dO2O7y0m7x7b8kZ4figlNc";
		private const string Sheet = "Students";
